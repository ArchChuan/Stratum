...
flowchart TB
  ...
  adapters["port_adapters.go<br/>ServerManagerAsPort<br/>RegistryAsAgentToolProvider/Executor"]
  skill["skill_adapter.go<br/>MCPToolCatalog / MCPToolRegistry / MCPToolHandle<br/>工具发现与执行桥接"]
  policy["tool_policy_repo.go<br/>PgToolPolicyRepo<br/>tenant 工具风险策略"]
