...
- [x] **Step 4: Verify GREEN and router regression**
...
Run: `cd web && ./node_modules/.bin/vitest run --config vitest.e2e.config.ts e2e/support/real-platform-assistant.test.ts`

Expected: FAIL because the cleanup guards do not exist.

- [x] **Step 3: Implement user-only cleanup**
...
- [x] **Step 4: Use cleanup in real specs**
...
- [x] **Step 2: Run canonical platform assistant E2E**
...
- [x] **Step 4: Run acceptance selection**
...
- [x] **Step 5: Commit verified follow-up changes**
