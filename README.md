...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-101.200.181.141-2ea44f?style=flat&logo=vercel&logoColor=white)](http://101.200.181.141)
...
[🚀 在线体验](http://101.200.181.141) · [📖 文档](#文档) · [⚡ 快速开始](#快速开始) · [🏛 架构总览](#架构总览) · [🤝 贡献](#贡献)

</div>

---

> **🌐 在线 Demo 已上线** — 访问 **<http://101.200.181.141>** 直接体验完整功能，无需本地部署。
> 支持 GitHub OAuth 一键登录，包含 Agent 对话、知识库、Skill 编排、MCP 工具全部核心能力。
...
> Demo 环境为单节点 K3s 部署，仅用于功能演示，数据每日重置。生产部署请参考 [`docs/DEPLOYMENT_GUIDE.md`](docs/DEPLOYMENT_GUIDE.md)。

</td>
<td width="40%" align="center">

[![Try it Live](https://img.shields.io/badge/▶%20Try%20it%20Live-101.200.181.141-2ea44f?style=for-the-badge)](http://101.200.181.141)
