...
describe('useDashboardPage', () => {
  beforeEach(() => { vi.clearAllMocks(); overview.mockResolvedValue(counts); });

  it('loads all overview counts atomically', async () => {
  ...
  it('keeps zero defaults and reports a persistent error', async () => {
