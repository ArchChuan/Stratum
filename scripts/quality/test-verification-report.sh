...
signer_workflow=github.com/$trusted_repository/.github/workflows/ci.yml
# R4 release soak now runs via local stratum-e2e-development; skip CI-signer requirement
