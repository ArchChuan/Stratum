...
all_packs='dashboard,iam,workflow,agent,skill,mcp,agent-skill-mcp,knowledge,memory,prompt,audit,evaluation,agent-context,evaluation-promotion,llm-admin,operation-gate,collab,scheduled-task'
