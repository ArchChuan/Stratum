...
grep -Fq 'export COMPOSE_PROJECT_NAME=${COMPOSE_PROJECT_NAME:-$common_compose_project}' "$runner" || {
  printf 'stateful E2E runner must share the common checkout compose project\n' >&2
  exit 1
}
