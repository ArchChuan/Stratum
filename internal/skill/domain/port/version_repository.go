...
type VersionRepo interface {
	...
	// UpdateDraftBundle takes editorActor: when non-empty, the actor's editor
	// qualification (tenant membership AND presence in resource_editors) is
	// re-validated inside the write transaction, closing the check-then-write
	// TOCTOU window for editor-granted updates.
