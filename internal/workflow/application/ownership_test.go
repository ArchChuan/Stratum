...
func TestEnforceWorkflowOwnershipMatrix(t *testing.T) {
	cases := []struct {
		...
		{"member creator empty editors update", "member", "m-1", "m-1", nil, OpEdit, nil},
		{"member non-creator empty editors update forbidden", "member", "m-2", "u-1", nil, OpEdit, domain.ErrForbidden},
		{"member creator delete forbidden", "member", "m-1", "m-1", nil, OpDelete, domain.ErrForbidden},
		{"member creator rollback forbidden", "member", "m-1", "m-1", nil, OpRollback, domain.ErrForbidden},
		{"member creator access forbidden", "member", "m-1", "m-1", nil, OpAccess, domain.ErrForbidden},
