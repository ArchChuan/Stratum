...
var errorStatusTable = map[error]int{
	...
	skilldomain.ErrPlatformManagedMCPServerBinding: http.StatusConflict,
	knowledgedomain.ErrPlatformManagedWorkspace:    http.StatusConflict,
	agentdomain.ErrPlatformManagedSkillBinding:     http.StatusConflict,
	agentdomain.ErrPlatformManagedMCPServerBinding: http.StatusConflict,
	...
	workflowdomain.ErrPlatformManagedSkill:         http.StatusConflict,
